...
Boolean RALPatchEntry(enum TableID table, UInt32 entry, void* NewHandlerAddress, void** OldHandlerAddress);
...
*/
		...
		/* res = */ RALPatchEntry(tbl, offset/4, (void *)newAddr, (void **)&prevAddr);
		return prevAddr;
	}else{
		UInt32 r9;
		UInt32 w;
